// ===================================================================================
// USB HID Multitouch Functions for CH551, CH552 and CH554                    * v1.0 *
// ===================================================================================
//
// Functions available:
// --------------------
...
void MT_touchDown(uint8_t count,
uint8_t contact_ident,
uint16_t x, uint16_t y);             // send a multitouch report for touch down
